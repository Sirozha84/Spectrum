                ...
                case 253:
                    ...
                    switch (Spectrum.Memory[PC++])
                    {
                        ...
                        case 203:
                            ...
                            {
                                case 78:                                        //BIT 1, (IY+S)
                                    fZ = (Spectrum.Memory[IplusS(IY)] & 2) == 0;
                                    return 23;
                                case 142:                                       //RES 1, (IY+S)
                                    Spectrum.Memory[IplusS(IY)] &= 253; //11111101
                                    return 23;
                                case 206:                                       //SET 1, (IY+S)
                                    Spectrum.Memory[IplusS(IY)] |= 2; //00000010
                                    //Spectrum.Memory[IplusS(IY)] = 123; //00000010
                                    return 23;
                            }
                            break;
                    }
