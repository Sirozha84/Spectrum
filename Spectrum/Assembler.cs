            ...
            switch (Z80.RAM[adr])
            {
                ...
                case 237: //После ED
                    switch (Z80.RAM[++adr])
                    {
                        ...
                        case 100: C = "NEG"; break;
                        case 101: C = "RETN"; break;
                ...
                case 253:
                    ...
                    switch (Z80.RAM[++adr])
                    {
                        ...
                        case 132: C = "ADD " + I + "H"; break;
                        case 133: C = "ADD " + I + "L"; break;
                        case 134: C = "ADD A, (" + I + SByte(++adr) + ")"; break;
                        case 140: C = "ADC " + I + "H"; break;
                        case 141: C = "ADC " + I + "L"; break;
                        case 142: C = "ADC A, (" + I + SByte(++adr) + ")"; break;
                        case 148: C = "SUB " + I + "H"; break;
                        case 149: C = "SUB " + I + "L"; break;
                        case 150: C = "SUB (" + I + SByte(++adr) + ")"; break;
                        case 156: C = "SBC " + I + "H"; break;
                        case 157: C = "SBC " + I + "L"; break;
                        case 158: C = "SBC A, (" + I + SByte(++adr) + ")"; break;
                        case 164: C = "AND " + I + "H"; break;
                        case 165: C = "AND " + I + "L"; break;
                        case 166: C = "AND (" + I + SByte(++adr) + ")"; break;
                        case 172: C = "XOR " + I + "H"; break;
                        case 173: C = "XOR " + I + "L"; break;
                        case 174: C = "XOR (" + I + SByte(++adr) + ")"; break;
                        case 180: C = "OR " + I + "H"; break;
                        case 181: C = "OR " + I + "L"; break;
                        case 182: C = "OR (" + I + SByte(++adr) + ")"; break;
                        case 188: C = "CP " + I + "H"; break;
                        case 189: C = "CP " + I + "L"; break;
                        case 190: C = "CP (" + I + SByte(++adr) + ")"; break;
                        case 203:
                            switch (Z80.RAM[adr++ + 2])
                            {

                                case 0: C = "LD B, RLC (" + I + SByte(adr) + ")"; break;
                                case 1: C = "LD C, RLC (" + I + SByte(adr) + ")"; break;
                                case 2: C = "LD D, RLC (" + I + SByte(adr) + ")"; break;
                                case 3: C = "LD E, RLC (" + I + SByte(adr) + ")"; break;
                                case 4: C = "LD H, RLC (" + I + SByte(adr) + ")"; break;
                                case 5: C = "LD L, RLC (" + I + SByte(adr) + ")"; break;
                                case 6: C = "RLC (" + I + SByte(adr) + ")"; break;
                                case 7: C = "LD A, RLC (" + I + SByte(adr) + ")"; break;
                                case 8: C = "LD B, RRC (" + I + SByte(adr) + ")"; break;
                                case 9: C = "LD C, RRC (" + I + SByte(adr) + ")"; break;
                                case 10: C = "LD D, RRC (" + I + SByte(adr) + ")"; break;
                                case 11: C = "LD E, RRC (" + I + SByte(adr) + ")"; break;
                                case 12: C = "LD H, RRC (" + I + SByte(adr) + ")"; break;
                                case 13: C = "LD L, RRC (" + I + SByte(adr) + ")"; break;
                                case 14: C = "RRC (" + I + SByte(adr) + ")"; break;
                                case 15: C = "LD A, RRC (" + I + SByte(adr) + ")"; break;
                                case 16: C = "LD B, RL (" + I + SByte(adr) + ")"; break;
                                case 17: C = "LD C, RL (" + I + SByte(adr) + ")"; break;
                                case 18: C = "LD D, RL (" + I + SByte(adr) + ")"; break;
                                case 19: C = "LD E, RL (" + I + SByte(adr) + ")"; break;
                                case 20: C = "LD H, RL (" + I + SByte(adr) + ")"; break;
                                case 21: C = "LD L, RL (" + I + SByte(adr) + ")"; break;
                                case 22: C = "RL (" + I + SByte(adr) + ")"; break;
                                case 23: C = "LD A, RL (" + I + SByte(adr) + ")"; break;
                                case 24: C = "LD B, RR (" + I + SByte(adr) + ")"; break;
                                case 25: C = "LD C, RR (" + I + SByte(adr) + ")"; break;
                                case 26: C = "LD D, RR (" + I + SByte(adr) + ")"; break;
                                case 27: C = "LD E, RR (" + I + SByte(adr) + ")"; break;
                                case 28: C = "LD H, RR (" + I + SByte(adr) + ")"; break;
                                case 29: C = "LD L, RR (" + I + SByte(adr) + ")"; break;
                                case 30: C = "RR (" + I + SByte(adr) + ")"; break;
                                case 31: C = "LD A, RR (" + I + SByte(adr) + ")"; break;
                                case 32: C = "LD B, SLA (" + I + SByte(adr) + ")"; break;
                                case 33: C = "LD C, SLA (" + I + SByte(adr) + ")"; break;
                                case 34: C = "LD D, SLA (" + I + SByte(adr) + ")"; break;
                                case 35: C = "LD E, SLA (" + I + SByte(adr) + ")"; break;
                                case 36: C = "LD H, SLA (" + I + SByte(adr) + ")"; break;
                                case 37: C = "LD L, SLA (" + I + SByte(adr) + ")"; break;
                                case 38: C = "SLA (" + I + SByte(adr) + ")"; break;
                                case 39: C = "LD A, SLA (" + I + SByte(adr) + ")"; break;
                                case 40: C = "LD B, SRA (" + I + SByte(adr) + ")"; break;
                                case 41: C = "LD C, SRA (" + I + SByte(adr) + ")"; break;
                                case 42: C = "LD D, SRA (" + I + SByte(adr) + ")"; break;
                                case 43: C = "LD E, SRA (" + I + SByte(adr) + ")"; break;
                                case 44: C = "LD H, SRA (" + I + SByte(adr) + ")"; break;
                                case 45: C = "LD L, SRA (" + I + SByte(adr) + ")"; break;
                                case 46: C = "SRA (" + I + SByte(adr) + ")"; break;
                                case 47: C = "LD A, SRA (" + I + SByte(adr) + ")"; break;
                                case 48: C = "LD B, SLL (" + I + SByte(adr) + ")"; break;
                                case 49: C = "LD C, SLL (" + I + SByte(adr) + ")"; break;
                                case 50: C = "LD D, SLL (" + I + SByte(adr) + ")"; break;
                                case 51: C = "LD E, SLL (" + I + SByte(adr) + ")"; break;
                                case 52: C = "LD H, SLL (" + I + SByte(adr) + ")"; break;
                                case 53: C = "LD L, SLL (" + I + SByte(adr) + ")"; break;
                                case 54: C = "SLL (" + I + SByte(adr) + ")"; break;
                                case 55: C = "LD A, SLL (" + I + SByte(adr) + ")"; break;
                                case 56: C = "LD B, SRL (" + I + SByte(adr) + ")"; break;
                                case 57: C = "LD C, SRL (" + I + SByte(adr) + ")"; break;
                                case 58: C = "LD D, SRL (" + I + SByte(adr) + ")"; break;
                                case 59: C = "LD E, SRL (" + I + SByte(adr) + ")"; break;
                                case 60: C = "LD H, SRL (" + I + SByte(adr) + ")"; break;
                                case 61: C = "LD L, SRL (" + I + SByte(adr) + ")"; break;
                                case 62: C = "SRL (" + I + SByte(adr) + ")"; break;
                                case 63: C = "LD A, SRL (" + I + SByte(adr) + ")"; break;
                                case 70: C = "BIT 0, (" + I + SByte(adr) + ")"; break;
                                case 78: C = "BIT 1, (" + I + SByte(adr) + ")"; break;
                                case 86: C = "BIT 2, (" + I + SByte(adr) + ")"; break;
                                case 94: C = "BIT 3, (" + I + SByte(adr) + ")"; break;
                                case 102: C = "BIT 4, (" + I + SByte(adr) + ")"; break;
                                case 110: C = "BIT 5, (" + I + SByte(adr) + ")"; break;
                                case 118: C = "BIT 6, (" + I + SByte(adr) + ")"; break;
                                case 126: C = "BIT 7, (" + I + SByte(adr) + ")"; break;
                                case 134: C = "RES 0, (" + I + SByte(adr) + ")"; break;
                                case 142: C = "RES 1, (" + I + SByte(adr) + ")"; break;
                                case 150: C = "RES 2, (" + I + SByte(adr) + ")"; break;
                                case 158: C = "RES 3, (" + I + SByte(adr) + ")"; break;
                                case 166: C = "RES 4, (" + I + SByte(adr) + ")"; break;
                                case 174: C = "RES 5, (" + I + SByte(adr) + ")"; break;
                                case 182: C = "RES 6, (" + I + SByte(adr) + ")"; break;
                                case 190: C = "RES 7, (" + I + SByte(adr) + ")"; break;
                                case 198: C = "SET 0, (" + I + SByte(adr) + ")"; break;
                                case 206: C = "SET 1, (" + I + SByte(adr) + ")"; break;
                                case 214: C = "SET 2, (" + I + SByte(adr) + ")"; break;
                                case 222: C = "SET 3, (" + I + SByte(adr) + ")"; break;
                                case 230: C = "SET 4, (" + I + SByte(adr) + ")"; break;
                                case 238: C = "SET 5, (" + I + SByte(adr) + ")"; break;
                                case 246: C = "SET 6, (" + I + SByte(adr) + ")"; break;
                                case 254: C = "SET 7, (" + I + SByte(adr) + ")"; break;
                            }
                            adr++;
                            break;
